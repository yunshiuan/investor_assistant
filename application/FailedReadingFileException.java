...
/**
 * The class for the exception when failing to read an external file.
 * 
 * @author Chuang, Yun-Shiuan (Sean)
 * @email ychuang26@wisc.edu
 * @date 20200730
 *
 */
public class FailedReadingFileException extends Exception {
	/**
	 ...
	 */
	public FailedReadingFileException(String msg) {
		super(msg);
	}
}
